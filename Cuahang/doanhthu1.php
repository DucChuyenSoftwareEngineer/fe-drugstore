			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						<li>
							...
							<a href="index.html">Doanh thu  cửa hàng trong tháng	</a>
						...
						<div class="row statistic-r">
							<div class="col-lg-4">
								<div class="statistic ">
									...
									<div class="statistic-letter">
										<p class="revenue" >Tổng Số Tiền Trong Ngày</p>
							...
							<div class="col-lg-4">
								<div class="statistic ">
									...
									<div class="statistic-letter">
										<p class="revenue">Tổng Số Hóa Đơn Trong Ngày</p>
										<p style="font-weight: bold;"><span>1200000</span> VNĐ</p>
				...
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<div style="margin-top: 2px; background: white; padding: 20px;">
						    <div style="display: flex; justify-content: space-between;">
								<div style="width: 310px; display: flex">
									<select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" style="width: 100%; height: 34px;">
										<option selected>ID</option>
										<option selected>Ngày Bán </option>
										<option value="1">Nhân Viên</option>
								
									</select>
									<input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" style="margin-left: 8px;"> 
									...
									<div class="search mb10" style="display: flex;">	
										...
										<div>
											<button type="button" class="btn btn-primary">Tiềm Kiếm</button>
										</div>
									  </div>
								
							</div>
							<div>
								<table class="table table-bordered table-hover mb2">
									...
									<tr>
										...
										<td>13/9/1993</td>
										<td>23h39</td>
										<td>40000 <span>VNĐ</span></td>
									
									 <td style="text-align: center;"><a href="#hd1" data-toggle="collapse" data-parent="#accordion">Xem chi tiết hóa đơn</a></td>
									  </tr>
									 
									  <tr id="hd1" class="collapse">
										<td colspan="7">
										  <div class="invoicedetails" style="padding: 20px;">
											<table class="table table-bordered table-hover mb2">
												<thead style="background: #EEEEEE;">
												  <tr>
													<th scope="col">STT</th>
												...
												<tbody>
												  <tr>
													...
													<td>Thuốc Điều Trị Sinh Lý</td>
													<td>10</td>
													<td>1500 <span>VNĐ</span></td>
									 ...
									 <tr>
										...
										<td>13/9/1993</td>
										<td>23h39</td>
										<td>5000 <span>VNĐ</span></td>
										
									 <td style="text-align: center;"><a href="#hd2" data-toggle="collapse" data-parent="#accordion">Xem chi tiết hóa đơn</a></td>
									  </tr>
									  
									  <tr id="hd2" class="collapse">
										<td colspan="7">
										  <div class="invoicedetails" style="padding: 20px;">
											<table class="table table-bordered table-hover mb2">
												<thead style="background: #EEEEEE;">
								  ...
								  <div class="footer_pagination" style="margin-top: -21px;float: right;margin-bottom: 34px;">
