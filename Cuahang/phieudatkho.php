					...
					<div class="row">
						<div class="col-md-12 col-sm-12" style="margin-bottom: 20px; overflow: hidden;">
							<div style="background: white; padding: 19px;">
								<div style="display: flex; justify-content: space-between;">
									<div>
										<h3 style="font-size: 15px; color: blue; font-weight: 700;">
											Phiếu yêu cầu nhập hàng : <span> nhà thuốc quận 7</span>
										</h3>
									</div>
								...
								<hr>
								<div class="f-s-c" style="margin-bottom: 10px; justify-content: end;">

									<div>
										<p style="font-size: 15px;font-weight: 600;">MãHĐ : <span>30</span></p>
										<p  style="font-size: 15px;font-weight: 600;">Nhân viên : <span>Nguyễn Văn A</span></p>
								...
								<div>
									...
									<table class="table table-bordered">
										...
										<tbody>
											<tr>
												...
												<td>
													<select class="js-example-basic-single" name="state"
														style="width: 100% !important;">
														<option value="AL">Ho</option>

														<option value="WY">Đau Đầu</option>
													</select>
												</td>
												<td>
													<select class="js-example-basic-single" name="state"
														style="width: 100% !important;">
														<option value="AL">MS001</option>

														<option value="WY">MS002</option>
													</select>
												</td>
												<td style="width: 100px;">

													<input style="height: 31px;" type="number" class="form-control"
														id="soluong">
												</td>
											...
											<tr>
												...
												<td style="text-align: center;"><button type="button"
														class="btn btn-primary"><i class="icon-close"></i></button></td>
												<td style="text-align: center;">
													<button type="button" class="btn btn-primary"><i
										...
										<tfoot>
											<tr>
												...
												<td colspan="4" style="text-align:center;">620000000 <span>VNĐ</span>
												</td>
											</tr>
										</tfoot>
										</tbody>
									...
									<div style="display: flex; justify-content: end;">
									  <div>
										<div><p style="font-size: 15px;font-weight: 900;">Ngày: <span>20/10/2021</span></p></div>
										<div>
											<button type="button" class="btn btn-primary">Lưu</button>
											<button type="button" class="btn btn-warning">Chuyễn kho</button>
										</div>
									  </div>
												...
												<li>
													<div class="col1">
														<div class="cont">
															...
															<div class="cont-col2">
																<div class="desc">
																	You have 5 pending membership that requires a quick
																	review.
																</div>
															</div>
														</div>
									...
									<div class="tab-pane page-quick-sidebar-settings" id="quick_sidebar_tab_3">
										<div class="page-quick-sidebar-settings-list">
											...
											<ul class="list-items borderless">
												<li>
													Enable Notifications <input type="checkbox" class="make-switch"
														checked data-size="small" data-on-color="success"
														data-on-text="ON" data-off-color="default" data-off-text="OFF">
												</li>
												<li>
													Allow Tracking <input type="checkbox" class="make-switch"
														data-size="small" data-on-color="info" data-on-text="ON"
											...
											<ul class="list-items borderless">
												...
												<li>
													Notify On System Error <input type="checkbox" class="make-switch"
														checked data-size="small" data-on-color="danger"
														data-on-text="ON" data-off-color="default" data-off-text="OFF">
												</li>
												<li>
													Notify On SMTP Error <input type="checkbox" class="make-switch"
														checked data-size="small" data-on-color="warning"
														data-on-text="ON" data-off-color="default" data-off-text="OFF">
												</li>
											</ul>
